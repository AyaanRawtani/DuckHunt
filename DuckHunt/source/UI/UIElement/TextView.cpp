...
namespace UI
{
	namespace UIElement
	{
		...
		const sf::String UI::UIElement::TextView::bubble_bobble_font_path = "assets/fonts/bubbleBobble.ttf";
		const sf::String UI::UIElement::TextView::DS_DIGIB_font_path = "assets/fonts/DS_DIGIB.ttf";
		...
		void UI::UIElement::TextView::loadFont()
		{
			font_bubble_bobble.loadFromFile(bubble_bobble_font_path);
			font_DS_DIGIB.loadFromFile(DS_DIGIB_font_path);
		}
